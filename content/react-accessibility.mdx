...
<Image src="/static/images/color-contrast.png" width={800} height={144} alt="Illustration of different contrast ratios" />
...
<Image
  src="/static/images/semantic-elements.png"
  width={791}
  height={556}
...
<Image src="/static/images/progress-bar.png" width={720} height={60} alt="Progress bar without any labelling" />
