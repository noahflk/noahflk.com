...
![Illustration of different contrast ratios](/static/images/color-contrast.png)
...
![Comparison between semantic elements like header, article, figure, and footer versus divs everywhere for a page layout](/static/images/semantic-elements.png)
...
![Progress bar without any labelling](/static/images/progress-bar.png)
