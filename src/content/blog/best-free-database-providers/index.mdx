...
<Image src={import('./supabase.png')} alt="Supabase dashboard" />
...
<Image src={import('./neon.jpg')} alt="Neon" />
...
<Image src={import('./turso.png')} alt="Turso" />
...
<Image src={import('./xata.png')} alt="Xata" />
