...
With this we have finished the setup of our Express.js API with Node.js and TypeScript. I use [Railway](https://railway.app?referralCode=M_kVxi) (referral) (referral) to deploy my Node servers. It’s the easiest platform I have found and very cheap to get started.
